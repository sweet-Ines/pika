...
function sendRequest(filename){
    ...
    //alert("made it in Request");
    xmlhttp.open("GET","php/getFavorites.php?filename="+filename, false);
    xmlhttp.send();
    //erstelleTabelle(json);
}

function Load(jfile) {
    //json = JSON.parse(sendRequest(jfile));
