...
$name = $_GET["type"];
    ...
    try {
        ...
        if ($name == "Musik") {
            ...
            $sql = "SELECT ATitel AS Albumtitel, Jahr AS Erscheinungsjahr, Songs, Interpreter, fav AS Favoriten, Genre FROM ALBUM";
            ...
            */
            ...
            $sql = "SELECT FTitel AS Filmtitel, Regie, Schauspieler, Erscheinungsjahr, Drehbuch, fav AS Favoriten, Genre FROM FILM";
            $result = mysqli_query($datenbank, $sql);
            $filme = array();
